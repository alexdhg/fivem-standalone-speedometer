...
-- SEATBELT PARAMETERS
local seatbeltInput = 47                   -- Toggle seatbelt on/off with B
    ...
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            if pedInVeh and GetIsVehicleEngineRunning(vehicle) and vehicleClass ~= 13 then
                ...
                drawTxt("Benzina", 2, fuelColorText, 0.4, screenPosX + 0.085, screenPosY + 0.018)
                ...
                if vehicleClass ~= 8 then
                    ...
                    drawTxt("Centura", 2, seatbeltColor, 0.4, screenPosX + 0.080, screenPosY + 0.048)
                end
            end
        end
    end
